...
public class VisitorController {
	...
	public ResponseEntity<List<VisitorEntity>> getVisitors(@PathVariable Integer pageNo,
	...
	public ResponseEntity<VisitorEntity> addgard(@PathVariable Long visitorId, @PathVariable Long gardId,

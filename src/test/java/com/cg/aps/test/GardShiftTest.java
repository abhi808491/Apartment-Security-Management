...
public class GardShiftTest {
	...
	public GardShiftEntity addGardShift() throws ParseException
	{
		GardShiftEntity gardShift=new GardShiftEntity();
		 ...
		 gardShift.setDate(new SimpleDateFormat("dd-MM-yyyy").parse("23-03-2022"));
	...
	void updateTest()
	{
		...
		assertEquals("2022-03-24 10:10:10.0",updatedGard.getModifiedDateTime());
